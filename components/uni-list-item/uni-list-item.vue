<template>
	...
	<cell>
		<!-- #endif -->
		<view :class="disabled ? 'uni-list-item--disabled' : ''" :hover-class="disabled || showSwitch || showMore ? '' : 'uni-list-item--hover'" class="uni-list-item" @click="onClick">
			<view class="uni-list-item__container" :class="{'uni-list-item--first':isFirstChild}">
				...
				<view class="uni-list-item__extra">
					...
					<view hover-class="uni-list-item--hover">
						<uni-icons v-if="showMore" :size="20" class="uni-icon-wrapper" color="#4d4d4d" type="more-filled" @click="onClickIcon" />
					</view>
